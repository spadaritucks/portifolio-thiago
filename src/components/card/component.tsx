...
export default function CardComponent({ image, title, project_type, description, client, github, github2, link }: ProjectProps) {
    ...
    return (
        <div className="w-96 h-auto border rounded-2xl flex flex-col items-start justify-start">
            ...
            <div className="flex flex-col items-start justify-start text-left px-4 py-8 gap-2">
                ...
                <p><span className="font-bold">Tipo do Projeto:</span> {project_type}</p>
                {client ? <p><span className="font-bold">Cliente:</span> {client}</p> : ""}
                <p><span className="font-bold">Descrição :</span> {description}</p>
