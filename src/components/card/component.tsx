...
export default function CardComponent({ image, title, project_type,languagens, description, client, github, github2, link }: ProjectProps) {
    ...
    return (
        <div className="w-[304px] h-[700px] rounded-2xl flex flex-col items-start justify-start shadow-2xl shadow-black">
            <img className="w-[304px] h-[174px]  rounded-t-2xl" src={image} alt="" />
